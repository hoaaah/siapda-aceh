...
/**
 * LdanadesaPenyaluranRkudSearch represents the model behind the search form about `app\models\LdanadesaPenyaluranRkud`.
 */
class LdanadesaPenyaluranRkudesaSearch extends LdanadesaPenyaluranRkudesa
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = LdanadesaPenyaluranRkudesa::find();
