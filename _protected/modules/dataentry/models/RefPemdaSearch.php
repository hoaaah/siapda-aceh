...
/**
 * RefPemdaSearch represents the model behind the search form about `app\models\RefPemda`.
 */
class RefPemdaSearch extends RefPemda
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'province_id', 'name', 'perwakilan_id'], 'safe'],
        ];
    }
