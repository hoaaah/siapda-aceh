...
/* @var $model app\modules\dataentry\models\LspipsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="lspips-search">
    ...
    <?php // echo $form->field($model, 'no_perkada') ?>

    <?php // echo $form->field($model, 'tanggal_perkada') ?>

    <?php // echo $form->field($model, 'pihak_bantu') ?>

    <?php // echo $form->field($model, 'ket') ?>

    <?php // echo $form->field($model, 'no_sk_satgas') ?>
