...
/* @var $model app\modules\dataentry\models\LlkpdSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="llkpd-search">
    ...
    <?php // echo $form->field($model, 'stat_lk') ?>

    <?php // echo $form->field($model, 'tanggal') ?>

    <?php // echo $form->field($model, 'pihak_bantu_susun') ?>

    <?php // echo $form->field($model, 'pihak_bantu_reviu') ?>

    <?php // echo $form->field($model, 'opini_id') ?>
