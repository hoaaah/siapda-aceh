            ...
            [
                ...
                'buttons' => [
                        'salur_rkud' => function ($url, $model) {
                          return Html::a('<span class="glyphicon glyphicon glyphicon-triangle-right"></span>', ['/dataentry/danadesarkud', 'pemda_id' => $model->pemda_id, 'pendapatan_desa_id' => $model->pendapatan_desa_id],
                              [  
                        ...
                        'salur_rkudesa' => function ($url, $model) {
                          return Html::a('<span class="glyphicon glyphicon-forward"></span>', ['/dataentry/danadesarkudesa', 'pemda_id' => $model->pemda_id, 'pendapatan_desa_id' => $model->pendapatan_desa_id],
                              [  
