...
<div class="lkada-form">
    ...
    <?= $form->field($model, 'status_kada')->widget(Select2::classname(), [
        'data' => [
            1 => 'Kepala Daerah',
            2 => 'Wakil Kepala Daerah',
        ],
        'options' => ['placeholder' => 'Kada/Wakada ...'],
        'pluginOptions' => [
            'allowClear' => false
        ],
    ]); ?>
    ...
    <?= $form->field($model, 'tanggal_lahir')->widget(\yii\jui\DatePicker::classname(), [
        ...
        'options' => ['class' => 'form-control', 'placeholder' => 'Tanggal Lahir']
    ]) ?>      

    <?= $form->field($model, 'partai')->textInput(['maxlength' => true]) ?>
