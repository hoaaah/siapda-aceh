...
class ProfilController extends Controller
{
    ...
    /**
     * Lists all LprofilPemda models.
     * @return mixed
     */
    public function actionIndex()
    {

        $searchModel = new LprofilPemdaSearch();
    ...
    /**
     * Displays a single LprofilPemda model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new LprofilPemda model.
    ...
    public function actionCreate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            $model->luas_wilayah = str_replace(',', '.', $model->luas_wilayah) ;
            $model->jumlah_penduduk = str_replace(',', '.', $model->jumlah_penduduk) ;
            IF($model->save()){
                return 1;
            }ELSE{
                return 0;
    ...
    /**
     * Updates an existing LprofilPemda model.
    ...
    /**
     * Deletes an existing LprofilPemda model.
    ...
    /**
     * Finds the LprofilPemda model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return LprofilPemda the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = LprofilPemda::findOne($id)) !== null) {
            return $model;
        } else {
