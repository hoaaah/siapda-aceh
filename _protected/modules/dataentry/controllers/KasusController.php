...
class KasusController extends Controller
{
    ...
    /**
     * Lists all Lkasus models.
     * @return mixed
     */
    public function actionIndex()
    {

        $searchModel = new LkasusSearch();
    ...
    /**
     * Displays a single Lkasus model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Lkasus model.
    ...
    /**
     * Deletes an existing Lkasus model.
    ...
    /**
     * Finds the Lkasus model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Lkasus the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Lkasus::findOne($id)) !== null) {
            return $model;
        } else {
