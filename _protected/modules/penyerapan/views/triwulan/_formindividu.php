...
<div class="penyerapan-triwulan-form">
    ...
    <?= $form->field($model, 'anggaran_tw1')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'anggaran_tw2')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'anggaran_tw3')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'anggaran_tw4')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'realisasi_tw1')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'realisasi_tw2')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'realisasi_tw3')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'realisasi_tw4')->textInput(['maxlength' => true]) ?>
