...
use app\modules\parameter\models\RefPerwakilanSearch;
...
/**
 * PerwakilanController implements the CRUD actions for RefPerwakilan model.
 */
class PerwakilanController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new RefPerwakilan",
                ...
                return [
                    ...
                    'title'=> "Create new RefPerwakilan",
                    'content'=>'<span class="text-success">Create RefPerwakilan success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing RefPerwakilan model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RefPerwakilan model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
