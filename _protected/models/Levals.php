...
class Levals extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['nilai_spip', 'nilai_sakip', 'nilai_lppd', 'nilai_iacm'], 'number'],
            [['created', 'updated'], 'safe'],
            [['bulan'], 'string', 'max' => 6],
            [['pemda_id'], 'string', 'max' => 5],
            [['tahun'], 'string', 'max' => 4],
            [['kat_spip', 'kat_sakip', 'kat_lppd', 'kat_iacm'], 'string', 'max' => 2],
            [['ket'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'kat_lppd' => 'Kat Lppd',
            'nilai_iacm' => 'Nilai Kapabilitas APIP',
            'kat_iacm' => 'Kat Kapabilitas APIP',
            'ket' => 'Ket',
            'user_id' => 'User ID',
            'created' => 'Created',
            'updated' => 'Updated',
