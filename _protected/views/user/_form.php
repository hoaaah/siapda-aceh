...
<div class="user-form">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <?php               
                echo $form->field($user, 'perwakilan_id')->widget(Select2::classname(), [
                    'data' => ArrayHelper::map(\app\models\RefPerwakilan::find()->select(['id', 'CONCAT(id, \' \', name) AS name'])->orderBy('id ASC')->all(),'id','name'),
